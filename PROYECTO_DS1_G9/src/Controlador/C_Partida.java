...
public class C_Partida implements ItemListener,ActionListener, KeyListener, MouseListener{
    ...
    public C_Partida(V_Partida vp){
        ...
        this.vp.btnExcelI.addActionListener(this);
        this.vp.btnExcelE.addActionListener(this);
        init();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==vp.btnExcelI || e.getSource()==vp.btnExcelE){
            Excel excel = new Excel();
            List<String> headers = Arrays.asList("Código Partida", "Código Partidas", "Descripción", "Tabs", "Elementos");
            excel.exportTablesToExcel(Arrays.asList(vp.tablaPartida_I, vp.tablaPartida_E), Arrays.asList(headers, headers), Arrays.asList("PartidasI", "PartidasE"), "Partidas");
        }
