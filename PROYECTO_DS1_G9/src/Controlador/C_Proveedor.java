...
public class C_Proveedor implements ActionListener, KeyListener, MouseListener{
    ...
    public C_Proveedor(V_Proveedor vp){
        ...
        this.vPro.btnExcel.addActionListener(this);
        init();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vPro.btnExcel) {
            Excel excel = new Excel();
            List<String> headers = Arrays.asList("CodProveedor", "DescPersona", "Ruc", "Vigente");
            excel.exportTableToExcel(vPro.tablaProveedor, headers, "Provedores");
