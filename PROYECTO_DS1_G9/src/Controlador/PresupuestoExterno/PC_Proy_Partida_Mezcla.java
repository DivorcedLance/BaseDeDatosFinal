...
import Modelo.DAO.PresupuestoExterno.PProy_PartidaDAO;
...
import Vistas.PresupuestoExterno.PV_Proy_Partida_Mezcla;
...
public class PC_Proy_Partida_Mezcla implements ItemListener,ActionListener, KeyListener, MouseListener{
    
    PProy_Partida_MezclaDAO ppmDAO = new PProy_Partida_MezclaDAO();
    PV_Proy_Partida_Mezcla vppm = new PV_Proy_Partida_Mezcla();
    ...
    public PC_Proy_Partida_Mezcla(PV_Proy_Partida_Mezcla vppm){
        this.vppm=vppm;
    ...
    public void initListarPartidas(int pyto){
        ...
        List<PartidaAux> listaParI = new PProy_PartidaDAO().getv_datos_partidas_padre(varCodCiaGlobalDeLogin, "I");
        ...
        List<PartidaAux> listaParE = new PProy_PartidaDAO().getv_datos_partidas_padre(varCodCiaGlobalDeLogin, "E");
    ...
    public void initTablaProyPartidaMezcla_I(){
        ...
        List listaI = new PProy_Partida_MezclaDAO().getv_proy_partida_mezcla(varCodCiaGlobalDeLogin,"I");
    ...
    public void initTablaProyPartidaMezcla_E(){
        @SuppressWarnings("rawtypes")
        List listaE = new PProy_Partida_MezclaDAO().getv_proy_partida_mezcla(varCodCiaGlobalDeLogin,"E");
        @SuppressWarnings("unchecked")
    ...
    public void eliminarDatos(String tip){
        ...
        if(tip=="I"){
            ...
            if(fila!=-1){
                ...
                ver = 1;
                new PProy_Partida_MezclaDAO().eliminarDatos(varCodCiaGlobalDeLogin,cod,tip,cor,pyto,ver);
            }else{
                showMessage1("Debe seleccionar una fila");
            }
        }
