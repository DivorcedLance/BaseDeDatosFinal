...
public class C_Empresa implements ActionListener, KeyListener, MouseListener {
    ...
    public C_Empresa(V_Empresa vEmpresa){
        ...
        this.vEmpresa.btnExcel.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vEmpresa.btnExcel) {
            Excel excel = new Excel();
            List<String> headers = Arrays.asList("CiaContrata", "Nombre", "Ruc", "Consorcio", "FecIni", "FecFin", "Vigente");
            excel.exportTableToExcel(vEmpresa.tablaEmpresa, headers, "Empresa");
