...
public class C_Cliente implements ActionListener, KeyListener,MouseListener  {
    ...
    public C_Cliente(V_Cliente vCliente){
        ...
        this.vCliente.btnExcel.addActionListener(this);
        init();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vCliente.btnExcel) {
            Excel excel = new Excel();
            List<String> headers = Arrays.asList("CodClient", "DescPersona", "RUC", "Vigente");
            excel.exportTableToExcel(vCliente.tablaCliente, headers, "Cliente");
        }
