...
public class C_Proy_Partida implements ActionListener, KeyListener, MouseListener{
    ...
    public C_Proy_Partida(V_Proy_Partida vpp){
        ...
        this.vpp.btnExcelI.addActionListener(this);
        this.vpp.btnExcelE.addActionListener(this);
        init();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vpp.btnExcelI || e.getSource() == vpp.btnExcelE) {
            Excel excel = new Excel();
            // 
            List<String> headers = Arrays.asList("Proyecto", "Partida");
            excel.exportTablesToExcel(Arrays.asList(vpp.tablaProy_Partida_I, vpp.tablaProy_Partida_E), Arrays.asList(headers, headers), Arrays.asList("TablaProyPartidaI", "TablaProyPartidaE"), "TablaProyPartida");
        }
    ...
    public void initTablaProy_Partida_I(){
        ...
        List listaI = new Proy_PartidaDAO().getv_proy_partida(varCodCiaGlobalDeLogin, "I");
    ...
    public void initTablaProy_Partida_E(){
            @SuppressWarnings("rawtypes")
            List listaE = new Proy_PartidaDAO().getv_proy_partida(varCodCiaGlobalDeLogin, "E");
            @SuppressWarnings("unchecked")
