...
public class Partida_Mezcla {
    ...
    public Partida_Mezcla(int codCia, String ingEgr, int codPartida, int corr, int padCodPartida, String tUnitMed,
            String eUnitMed, float costoUnit, int nivel, int orden, char vigente) {
        this.codCia = codCia;
        this.ingEgr = ingEgr;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Partida_Mezcla) {
            Partida_Mezcla p = (Partida_Mezcla) obj;
            return p.codCia == this.getCodCia() &&
                    p.ingEgr.equals(this.getIngEgr()) &&
                    p.codPartida == this.getCodPartida() &&
                    p.corr == this.getCorr();
        }
        return false;
    }
