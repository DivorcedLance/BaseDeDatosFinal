...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem(){
        ...
        addMenu(new ModeloMenu(new ImageIcon(getClass().getResource("/image/8_s.png")), "Proyectos", "Consulta de proyectos"));
        addMenu(new ModeloMenu(new ImageIcon(getClass().getResource("/image/9_s.png")), "Presupuesto Interno", "Partidas","Config Partidas","Partidas de Proyecto","Config. Part. Proy.", "Registrar Ventas", "Registrar Pagos"));
        addMenu(new ModeloMenu(new ImageIcon(getClass().getResource("/image/5_s.png")), "Presupuesto Externo", "Partidas","Config Partidas","Partidas de Proyecto","Config. Part. Proy.", "Registrar Ventas", "Registrar Pagos"));
        addMenu(new ModeloMenu(new ImageIcon(getClass().getResource("/image/3_s.png")), "Contenido Multimedia", "Fotos y Videos"));
        addMenu(new ModeloMenu(new ImageIcon(getClass().getResource("/image/11_s.png")), "Flujo de Caja", "Presupuesto Interno", "Presupuesto Externo"));
